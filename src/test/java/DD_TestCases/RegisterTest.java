...
public class RegisterTest extends Page
{
   ...
   {
      test = extent.startTest("Execution of Register Test");
   ...
   public void afterTest(ITestResult result) throws IOException
   {
      ...
      else if (ITestResult.FAILURE == result.getStatus())
      {
         ...
         test.log(LogStatus.FAIL, "Test Case Register is failed" + test.addScreenCapture(Commons.captureScreenshot(methodname)));
