...
public class Page
{
   ...
   {
      fis = new FileInputStream(System.getProperty("user.dir") +"\\src\\test\\java\\DD_Config\\Config.properties");
      ...
      fis = new FileInputStream(System.getProperty("user.dir") +"\\src\\test\\java\\DD_Config\\OR.properties");
      OR = new Properties();
      OR.load(fis);
